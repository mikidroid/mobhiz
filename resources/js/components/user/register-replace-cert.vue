...
<li>Labels</li>
  ...
  >
    <v-card-title class="text-h6 font-weight-regular justify-space-between">
      <span><h3>Replace certificate</h3></span>
      <v-avatar
 ...
 export default {
  ...
  methods:{
    ...
    sendEmail(val){
     ...
     let body=`
      <div>
      <p>Dear ${this.user.firstname}, we are pleased to inform you that your REPLACE CERTIFICATE order has been placed.</p>
      <p></p>
