 ...
 <div class="container">
  ...
  >
    <v-card-title class="text-h6 font-weight-regular justify-space-between">
      <span><h3>Edit CAC registration Details</h3></span>
      <v-avatar
 ...
 export default {
  components:{paystack},
    data(){
      return{
         ...
         UPDATE_REGISTERED_BUSINESS:updateApi.UPDATE_REGISTERED_BUSINESS,
         VIEW_REGISTERED_BUSINESS:getApi.VIEW_REGISTERED_BUSINESS,
  ...
  methods:{
    ...
    sendEmail(val){
     ...
     let body=`
      <div>
      <p>Dear ${this.user.firstname}, we are pleased to inform you that your BUSINESS REGISTRATION order has been edited.</p>
      <p></p>
    ...
    submitDetails(){
       ...
       //this.axios.post('/api/register-product',doc,Config).
           this.UPDATE_REGISTERED_BUSINESS(this.$route.params.id,form)
           .then(r=>{
     ...
     created(){
      ...
      this.VIEW_REGISTERED_BUSINESS(this.$route.params.id).then(r=>{
        this.data=r.data;
