...
<li> CAC certificate</li>
  ...
  >
    <v-card-title class="text-h6 font-weight-regular justify-space-between">
      <span><h3>Register Trademark</h3></span>
      <v-avatar
 ...
 export default {
  ...
  methods:{
    ...
    sendEmail(val){
     ...
     let body=`
      <div>
      <p>Dear ${this.user.firstname}, we are pleased to inform you that your TRADEMARK REGISTRATION order has been placed.</p>
      <p></p>
